/**
 * Element Plus wrappers — chỉnh 1 chỗ, dùng toàn CMS.
 *
 * @example
 * import { CustomInput, CustomButton, CustomTable } from '@/components/element'
 */
...
export { default as CustomEmpty } from './CustomEmpty.vue'
